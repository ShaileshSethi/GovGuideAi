      ...
      >
        ...
        <nav className="flex-1 px-4 py-6 space-y-2">
          ...
          <Link
            href="/knowledge"
            onClick={() => setIsSidebarOpen(false)}
            className={`flex items-center px-4 py-3 rounded-xl font-medium transition-colors ${pathname === '/knowledge' ? 'text-[#2563EB] bg-[#EFF6FF]' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'}`}
          >
